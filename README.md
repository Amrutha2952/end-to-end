This project implements a simple web application for sentiment analysis. It uses a pre-trained machine learning model to classify the sentiment of input text as either positive or negative.
